      ...
      <section className="w-full py-8 pb-4 md:pb-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Buttons - Right side on desktop */}
            <div className="flex flex-col justify-center items-center lg:items-end space-y-6">
              {/* Phone Number Button */}
              <a
                href="tel:07352167642"
                className="w-full lg:w-[400px] border-2 border-white bg-black/70 backdrop-blur-md rounded-full px-8 py-5 flex items-center justify-center gap-4 text-white text-xl font-sans font-semibold transition-all duration-300 hover:bg-white hover:text-black hover:border-white hover:scale-105 active:scale-95 group"
              >
                <svg
