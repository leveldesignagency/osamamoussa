      ...
      <section className="w-full py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black/70 backdrop-blur-md p-8 space-y-6 text-white z-10">
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    className="text-white text-xl font-sans font-semibold hover:opacity-60 transition-opacity"
                  >
                    07352167642
                  </a>
                </div>
            ...
            {/* Contact Form */}
            <form onSubmit={handleSubmit} className="bg-black/50 backdrop-blur-sm p-6 space-y-4 border-2 border-white/20">
              <div>
                <label htmlFor="name" className="block text-white mb-2 font-sans font-semibold">
              ...
              <div>
                <label htmlFor="email" className="block text-white mb-2 font-sans font-semibold">
              ...
              <div>
                <label htmlFor="phone" className="block text-white mb-2 font-sans font-semibold">
              ...
              <div className="relative">
                <label htmlFor="procedures" className="block text-white mb-2 font-sans font-semibold">
              ...
              <div>
                <label htmlFor="message" className="block text-white mb-2 font-sans font-semibold">
      ...
      <section className="w-full py-16 min-h-[600px]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            {/* Left Column - TOP DOCTOR CERTIFIED */}
            ...
            {/* Right Column - Widget Type 6 in iPhone Mockup */}
            <div className="p-8 min-h-[500px] flex justify-center items-start">
              {/* iPhone Mockup - Flat */}
              <div className="relative">
                <div 
